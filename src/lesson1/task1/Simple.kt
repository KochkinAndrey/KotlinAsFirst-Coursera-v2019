 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = (deg.toDouble() + min.toDouble() / 60.0 + sec.toDouble() / 3600.0) * PI / 180.0
...
fun accountInThreeYears(initial: Int, percent: Int): Double {
    ...
    for (i in 0..2) {
        result += result * percent.toDouble() / 100.0
    }
    return result
}
